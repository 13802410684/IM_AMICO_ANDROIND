...
//    IM服务器相关
    public static final String HOST_IM = "192.168.3.13";//示例ip: 119.125.523.153 此IP不可用
    public static final int HOST_PORT = 6789;//示例ip: 119.125.523.153 此IP不可用
    //api服务器
    public static final String HOST_API = "http://192.168.3.13/amico";//示例ip: 119.125.523.153 此IP不可用
    //阿里云OSS信息配置
    public static final String endpoint = "oss-cn-hangzhou.aliyuncs.com";
    public static final String accessKeyId = "xxxxxxxx";
    public static final String accessKeySecret = "xxxxxxxxxxxx";
    public static final String bucket = "192.168.3.13";
    ...
    public static final String DEV_TYPE = "ANDROID";//示例ip: 119.125.523.153 此IP不可用
    //应用层使用到的api接口
    public static final String URL_AVATAR= HOST_API + "upload/";
    public static final String URL_REGISTER = HOST_API + "register";//注册
    public static final String URL_LOGIN = HOST_API + "/chat/imLoginService";//登录
     public static final String URL_FriendList = HOST_API + "fetchFriends";//获取好友列表
    public static final String URL_Search_User = HOST_API + "/friend/searchFriend";//查询好友
    public static final String URL_Get_UserInfo = HOST_API + "/chat/userDeatil";//获取详情
