...
import com.amico.im.mn.sdk.client.AmicoOptions;
...
public class HTClientHelper {
    ...
    public HTClientHelper(Context context) {
        ...
        //初始化我的
        AmicoOptions amicoOptions = new AmicoOptions();
        AmicoClient.init(applicationContext,amicoOptions);
        AmicoClient.newInstance().setMessageLisenter(messageLisenter);
